...
public class RegisterWithInvaildData {
	...
	public static By REGISTER_TERMS_CONDITIONS = By.cssSelector("#Terms & Conditions & Privacy Policy");
	...
	public static void main(String[] args) {
		...
		driver.findElement(REGISTER_EMAIL).sendKeys("testusermail.com");
		...
		driver.findElement(REGISTER_PASSWORD).sendKeys("sdvb");
		driver.findElement(REGISTER_CONFIRM_PASSWORD).clear();
		driver.findElement( REGISTER_CONFIRM_PASSWORD).sendKeys("sdb");
